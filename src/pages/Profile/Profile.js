                ...
                <div className="forms">
                  <div className="radio-input">
                    <div className="form-check form-check-inline">
                      <input className="form-check-input shadow-none" type="radio" name="gender" id="inlineRadio1" value="Male" onChange={this.formChange} />
                      <label className="form-check-label male-label" for="inlineRadio1">
                        Male
                      </label>
                    </div>
                    <div className="form-check form-check-inline female">
                      <input className="form-check-input shadow-none" type="radio" name="gender" id="inlineRadio2" value="Female" onChange={this.formChange} />
            ...
            <Modal show={this.state.isShow} centered>
              ...
              <Modal.Footer className="modal-footer">
                <div className="modal-btn">
                  ...
                  <button className="btn btn-light" onClick={this.onCLickLogout}>
                    yes
                  </button>
                </div>
              </Modal.Footer>
